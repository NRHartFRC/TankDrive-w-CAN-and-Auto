...
// create a class called TimedDriveStraightCommand that is a subclass of the CommandBase superclass
public class TimedDriveStraightCommand extends CommandBase {
    ...
    // create a constructor, a method that initializes and configures the objects in the TimedDriveStraightCommand class
    public TimedDriveStraightCommand(final double time, final double driveRate) {
