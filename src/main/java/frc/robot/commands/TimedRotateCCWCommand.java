...
// create a class called TimedRotateCCWCommand that is a subclass of the CommandBase superclass
public class TimedRotateCCWCommand extends CommandBase {
    ...
    // create a constructor, a method that initializes and configures the objects in the TimedRotateCCWCommand class
    public TimedRotateCCWCommand(final double time, final double rotateRate) {
    ...
    public void execute() {
        ...
        if (currentTime < this.duration) {
            this.m_drivetrainSubsystem.drive(this.rotateRate, -this.rotateRate);
        }
        else {
